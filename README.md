...
### 1.7.0 Install 版—基于20.8的安装镜像，预装星火4.0  
...
### 1.7.0——跟进新版Deepin20.8、LinuxQQ（非 Install 版）  
#### Mini 版  
...
### 1.4.0——基于20.7，新增Ghost（非 Install 版）  
...
### 1.3.0——优化 Full 版体积、制作方式、应用商店（非 Install 版）  
...
### 1.2.0 归来——支持运行官方安装程序安装（有 Install 版）  
